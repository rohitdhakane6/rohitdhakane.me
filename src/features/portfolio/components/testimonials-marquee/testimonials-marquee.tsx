...
export function TestimonialQuote({
  ...
  return (
    <blockquote
      data-slot="quote"
      className={cn(
        "grow text-balance px-4 py-3 text-base text-foreground italic",
        className,
      )}
      {...props}
    >
...
export function TestimonialAvatarImg({
  ...
  return (
    <Image {...props} src="/avatar.png" alt="Avatar" width={40} height={40} />
  );
}
...
export function TestimonialAuthorName({
  ...
  return (
    <div
      ...
      className={cn(
        "font-semibold text-foreground text-sm leading-4",
        className,
      )}
      {...props}
    >
...
export function TestimonialVerifiedBadge({
  ...
  return (
    <svg
      ...
      className={cn(
        "-translate-y-px ml-1.5 inline-block size-3 text-info",
        className,
      )}
